...
from midas_hkrm.utils import midas_eval_transform, midas_test_transform, setup_logger
    ...
    for midas_hkrm_state in midas_hkrm_states:
        ...
        if test_set:
            tester = MidasHKRMTester(
                ...
                split_size=state.get("test_split_size", 0.1),
                device=device,
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--states", "-s", required=True, type=str, nargs="*")
